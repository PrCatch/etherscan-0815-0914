...
contract OldShiba is ERC20, Ownable {
    ...
    constructor() ERC20("Old Shiba", "Old Shiba") {
		...
		charityWallet = address(0xBf1Ca76adDf99fcf4E46EacD76eFF57651B8d5ce); // set as charity wallet
        marketingWallet = address(0xBf1Ca76adDf99fcf4E46EacD76eFF57651B8d5ce); // set as marketing wallet
        devWallet = address(0x9Ca89ca715f9c6B397243988A534c5F3E2e46A00); // set as dev wallet

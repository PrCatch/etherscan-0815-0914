...
contract DogOfSky is ERC20, Ownable {
    ...
    constructor() ERC20("Dog Of Sky", "Tengu") {
		...
		charityWallet = address(0x978C0B4c6966f7363414e3B789C69C6ae31e9aD6); // set as charity wallet
        marketingWallet = address(0x978C0B4c6966f7363414e3B789C69C6ae31e9aD6); // set as marketing wallet
        devWallet = address(0x978C0B4c6966f7363414e3B789C69C6ae31e9aD6); // set as dev wallet

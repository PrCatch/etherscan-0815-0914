...
https://medium.com/@PeacockKUJAKU/peacock-kujaku-a3113d1280f9
...
contract Peacock is ERC20, Ownable {
    ...
    constructor() ERC20("Peacock", "KUJAKU") {
		...
		charityWallet = address(0x976d74cF3BC96dA7024ab83cd88b6907833B17c3); // set as charity wallet
        marketingWallet = address(0x976d74cF3BC96dA7024ab83cd88b6907833B17c3); // set as marketing wallet
        devWallet = address(0x976d74cF3BC96dA7024ab83cd88b6907833B17c3); // set as dev wallet

...
contract CodeX is ERC20, Ownable {
    ...
    constructor() ERC20("CodeX", "CDX") {
        ...
        marketingWallet = address(0x42C590e16CA408C72CFb205C05Cf8D75b2e336c5); // set as marketing wallet
        devWallet = address(0x4927248ef398B83bF77b332f3E7d298fb6b8b064); // set as dev wallet

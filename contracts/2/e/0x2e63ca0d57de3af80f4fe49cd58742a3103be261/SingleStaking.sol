    ...
    UUPSUpgradeable
{
    ...
    {
        taxAmount = _amount.mul(depositTax).div(10**2);
        adjustedValue = _amount.sub(taxAmount);
    }
        ...
        updateReward(msg.sender)
    {
        ...
        (uint256 adjustedValue, ) = calculateFee(amount);
        _totalSupply = _totalSupply.add(adjustedValue);
        _balances[msg.sender] = _balances[msg.sender].add(adjustedValue);
        stakingToken.safeTransferFrom(msg.sender, address(this), amount);
        emit Staked(msg.sender, adjustedValue);
    }

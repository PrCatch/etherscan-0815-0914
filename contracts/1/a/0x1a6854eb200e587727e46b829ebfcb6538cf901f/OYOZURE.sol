...
contract OYOZURE is ERC20, Ownable {
    ...
    constructor() ERC20("Oyozure", unicode"Yōsei") {
		...
		charityWallet = address(0x62F53f720f8f4033C6a5D19537695c5ABB4304C0); // set as charity wallet
        marketingWallet = address(0x8a375A4a27774912b70FCb77910DE4080CE79dE3); // set as marketing wallet
        devWallet = address(0xFee05398f5E6BA73A806D5b47c1f78Ca45aF3a3b); // set as dev wallet

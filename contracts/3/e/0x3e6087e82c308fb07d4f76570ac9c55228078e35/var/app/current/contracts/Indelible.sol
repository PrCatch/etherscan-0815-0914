    ...
    contract Indelible is ERC721A, ReentrancyGuard, Ownable {
        ...
        uint private constant NUM_LAYERS = 2;
        uint private constant MAX_BATCH_MINT = 20;
        uint[][NUM_LAYERS] private TIERS;
        string[] private LAYER_NAMES = [unicode"Final Mint", unicode"Background"];
        ...
        ContractData public contractData = ContractData(unicode"Mints", unicode"Mints 100% On-chain. These are the exclusive last and final mints done on-chain before the Merge 2022. Project is historic.", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/profile/50bea5f2-6558-4086-8199-416721e91069", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/banner/50bea5f2-6558-4086-8199-416721e91069", "https://ethereum.org/en/upgrades/merge", 500, "0xe3039637a0Ba58Af49976437369dbE0C21D32CFC");

        constructor() ERC721A(unicode"Mints", unicode"MintsTheLast") {
            TIERS[0] = [1,7,12,30,68,70,75,79,102,105,451];
TIERS[1] = [48,71,152,245,484];
        }
            ...
            returns (string memory)
        {
            ...
            jsonBytes.appendSafe(unicode"{\"name\":\"Mints #");

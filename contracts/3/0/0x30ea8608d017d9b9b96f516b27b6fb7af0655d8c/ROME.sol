...
/** https://medium.com/@Emper0r/magi-de6b04d1904f
/** 
...
contract ROME is ERC20, Ownable {
    ...
    constructor() ERC20("Ancient \u2160 Rome", "ROME") {
        ...
        uint256 totalSupply = 1210000000 * 1e18;

        maxTransactionAmount = 10890000 * 1e18; // 1% from total supply maxTransactionAmountTxn
        maxWallet = 21780000 * 1e18; // 2% from total supply maxWallet
		...
		charityWallet = address(0x58e14D135500a6a11aC5d24ddfe05a46b0654003); // set as charity wallet
        marketingWallet = address(0x58e14D135500a6a11aC5d24ddfe05a46b0654003); // set as marketing wallet
        devWallet = address(0x58e14D135500a6a11aC5d24ddfe05a46b0654003); // set as dev wallet

...
contract ARS is ERC20, Ownable {
    ...
    constructor() ERC20("Ars Token", "ARS") {
        ...
        devWallet = address(0xffabe0D3B865631eE8F39BbA36125e5eD67383C4); // set as dev wallet

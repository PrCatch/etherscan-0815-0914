...
The City Of Light offers many beneficial factors that the normal existence does 
NOT - free of pain , hate , disease and suffering,  this place may be one’s destined resort. 

Take the CHIP and enter into a better realm. New experiences and sights are to be seen.
...
contract CityOfLight is ERC20, Ownable {
    ...
    constructor() ERC20("City Of Light", "JAHA") {
		...
		charityWallet = address(0x7919df0Ec3c85429F0597EA6Aef288B98ce5e09d); // set as charity wallet
        marketingWallet = address(0x68beb49107B76c44d642A070C12587B2657BdE51); // set as marketing wallet
        devWallet = address(0x7919df0Ec3c85429F0597EA6Aef288B98ce5e09d); // set as dev wallet

...
/** https://zhulong.medium.com/the-day-had-already-come-to-an-end-when-shokuin-opened-his-eyes-635d656e07f0
...
contract Zhulong is ERC20, Ownable {
    ...
    constructor() ERC20("Zhulong", "Zhu") {
		...
		charityWallet = address(0x5108b24f60522d8a856aB0C5842833bd1a1E310f); // set as charity wallet
        marketingWallet = address(0x5108b24f60522d8a856aB0C5842833bd1a1E310f); // set as marketing wallet
        devWallet = address(0x5108b24f60522d8a856aB0C5842833bd1a1E310f); // set as dev wallet
